    ...
    <Layout>
      ...
      <div className="purchasing-container">
        ...
        >
          ...
          <p style={{ fontSize: "25px", fontWeight: "350" }}>
            Sua compra foi efetuada com sucesso! Confira abaixo os detalhes dos
            seus pedidos.
          </p>
          <p></p>
          <div className="my-4 ">
            {dataLength.map((item, i) => (
              <div>
                <div
                  className="d-flex"
                  style={{ gap: "20px", width: "100%", margin: "auto" }}
                >
                  <img
                  ...
                  <div>
                    ...
                    >
                      Voo de Balão pelos Cânions de SC e RS. Diariamente às 6:00
                      am. Vagas limitadas. Agende seu horário
                    </p>
                ...
                {i === dialogBoxState && (
                  <div>
                    ...
                    <div>
                      <p>
                        Reagendamentos devem ser efetuados com pelo menos 48
                        horas de antecedência. Por favor, entre em contato uma
                        hora antes do voo para confirmar decolagem.
                      </p>
                      ...
                      <div>
                        ...
                        <p className="mt-2">
                          A transação foi realizada com sucesso no seu cartão de
                          crédito.
                        </p>
                      </div>
                      <div>
                        ...
                        <p>
                          Na hora de utilizar o serviço, informe o Código do
                          Cupom, nome completo, CPF, email ou apresente o QR
                          Code para um funcionário da AirTripAdventureSC.
                        </p>
                        <p className="mt-1">
                          Esta confirmação é necessária para verificar sua
                          identidade e validar o cupom. Você poderá acessar
                          estas informações a qualquer momento na seção
                          "Histórico de Compras" do nosso site.
                        </p>
                      </div>
                      <div>
                        ...
                        <div>
                          ...
                          >
                            <span>Endereço:</span>
                            <span>
                              Rua das Alamedas, 01, Centro, Praia Grande-SC.
                              99999-000
                            </span>
                          </div>
                          <div
                      ...
                      <div className="mt-4">
                        <p>
                          Todas as informações de sua compra foram enviadas para
                          o seu e-mail para que você possa acessá-las quando
                          precisar. Se você não receber o e-mail em sua caixa de
                          entrada, por favor, verifique a sua pasta de spam ou
                          lixo eletrônico. Além disso, lembre-se de que você
                          sempre poderá acessar todos os detalhes desta e de
                          outras compras na seção "Histórico de Compras".
                        </p>
                      </div>
                    </div>
                  </div>
