          ...
          <div className="my-4 ">
            ...
            >
              ...
              <div>
                ...
                >
                  Voo de Balão pelos Cânions de SC e RS. Diariamente às 6:00 am.
                  Vagas limitadas. Agende seu horário
                </p>
              ...
              <div className="d-flex col-6 flex-column">
                ...
                {steps === 0 && (
                  <div className="mt-4">
                    ...
                    <div
                      className="d-flex col-12 align-items-center mt-3 mx-2"
                      style={{ gap: "8px" }}
                    >
                      <input type="checkbox" />
                      <div style={{ color: "gray" }}>
                        Concordar com
                        <b> Termos de Uso </b>e<b> Políticas de Privacidade</b>
                      </div>
                    </div>
                ...
                {steps === 1 && (
                  <div className="mt-4">
                    ...
                    >
                      ...
                      <div style={{ color: "gray" }}>
                        <p className="m-0">
                          Guardar cartáo para as pròximas compras
                        </p>
                      </div>
                    </div>
                    <div
                ...
                {steps === 2 && (
                  <div className="mt-4">
                    ...
                    <div className="col-12 my-4">
                      <div>
                        <span>É simples e seguro:</span>
                        <div>
                          <li className="my-3">
                            1. Após finalizar compra, o código Pix ficará
                            disponível para você pagar no Banco da sua escolha.
                          </li>
                          <li className="my-3">
                ...
                {steps === 3 && (
                  <div className="mt-4">
                    ...
                    <div className="col-12 my-4">
                      ...
                      >
                        Não perca o seu pedido! O prazo para pagamento do pix é
                        de 01:59:57
                      </p>
                      <div
                      ...
                      >
                        Utilize o app do seu banco para escanear o QR Code ou
                        copie o código PIX
                      </p>
                      ...
                      <div
                        ...
                        className="d-flex col-12 justify-content-center align-items-center  mx-2"
                      >
                      ...
                      <div style={{ marginTop: "15px", color: "gray" }}>
                        <span>
                          Lembre-se de que você sempre poderá acessar todos os
                          detalhes desta e de outras compras na seção
                        </span>
